...
\begin{itemize}
    \item Mantén tu distribución TeX y tu editor siempre actualizados.
    \item Guarda tus imágenes y recursos en la misma carpeta que tu `.tex`.
    \item Usa nombres simples y sin espacios para los archivos y carpetas.
\end{itemize}
